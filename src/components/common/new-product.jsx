...
import { getBestSeller, getLocale } from "../../services";
...
class NewProduct extends Component {
    render() {
        ...
        const { items, symbol, locale } = this.props;
                        ...
                        <div key={index}>
                            {products.map((product, i) =>
                                <div className="media" key={i}>
                                    <Link to={`${process.env.PUBLIC_URL}/left-sidebar/product/${product.id}`}><img style={{ height: '100px' }} className="img-fluid" src={product.images}
