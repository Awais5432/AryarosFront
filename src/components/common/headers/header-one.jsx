		...
		return (
			<div>
				<header id="sticky" className="sticky">
					...
					<TopBar/>
				<div style={{boxShadow: '0 2px 4px rgb(0 0 0 / 30%)'}}>
					<div className="container">
						<div className="row">
							<div className="col-sm-12" style={{padding:'unset'}}>
								<div className="main-menu">
									...
									{/* </div> */}
									<div className="menu-right pull-right" style={{width:'100%'}}>
										...
										<div className="pr-4">
											<div className="icon-nav">
												<ul>
													<li className="onhover-div mobile-search" style={{paddingTop:'20px',paddingBottom:'20px'}}>
													...
													{/* <li className="onhover-div mobile-setting" style={{paddingTop:'20px',paddingBottom:'20px'}}>
