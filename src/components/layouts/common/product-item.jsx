    ...
    render() {
        ...
        return (
            <div className="product-box">
                <div className="img-wrapper" style={{ backgroundColor: '#eee' }}>
                    ...
                    <div className="front" style={{
                        ...
                        <Link to={`${process.env.PUBLIC_URL}/left-sidebar/product/${product.id}`} ><img
                            ...
                            //         : product.pictures[0]
                            //     }`}
                            className="img-fluid" style={{ borderRadius: '6px' }}
                            alt="" /></Link>
                    </div>
                ...
                <div className="product-detail">
                    <div>
                        ...
                        <button className='btn-solid btn mb-1' title="Add to cart" onClick={onAddToCartClicked} style={{ padding: '8px', borderRadius: '3px', width: '100%' }}>
                            Add To Cart
                        </button>
                        <Link to={`${process.env.PUBLIC_URL}/left-sidebar/product/${product.id}`}>
                            {(() => {
                                if (this.state.locale == 'en') {
                                    ...
                                    return <h6>{product.name_arabic}</h6>
                            })()}
                                        ...
                                        <div className="product-right">
                                            {(() => {
                                                if (this.state.locale == 'en') {
                                                    ...
                                                    return <h2>{product.name_arabic}</h2>
                                            })()}
