...
import SubCategory from './components/collection/subcategory';
                    ...
                    <BrowserRouter basename={'/'} >
                        <ScrollContext>
                            <Switch>
                                ...
                                <Layout>
                                    <Route path={`${process.env.PUBLIC_URL}/category/:id`} component={Category} />
                                    <Route path={`${process.env.PUBLIC_URL}/subcategory/:id`} component={SubCategory} />
                                    ...
                                    <Route path={`${process.env.PUBLIC_URL}/checkoutdetails`} component={CheckoutDetails} />
